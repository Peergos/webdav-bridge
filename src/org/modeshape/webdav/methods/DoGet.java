...
public class DoGet extends DoHead {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    logger.warn(e, "Closing InputStream causes Exception!");
                }
                try {
                    out.flush();
                    out.close();
                } catch (Exception e) {
                    logger.warn(e, "Flushing OutputStream causes Exception!");
                }
            }
        } catch (Exception e) {
        ...
        if (so == null) {
            ...
            if (so.isFolder()) {
                ...
                for (String child : children) {
                    ...
                    if (obj == null) {
                        logger.error("Should not return null for " + path + "/" + child);
                    }
    ...
    protected String getCSS() {
        ...
        try {
            ...
            logger.error(ex, "Error in reading webdav.css");
        }
